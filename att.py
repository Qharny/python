...
def take_attendance():
    ...
    def update_summary():
        ...
        summary_label.config(text=f"Total Students: {len(student_attendance)}\nPresent: {present_count}\nAbsent: {absent_count}")
    ...
    present_radio = tk.Radiobutton(window, text="Present", variable=status_var, value="Present")
    absent_radio = tk.Radiobutton(window, text="Absent", variable=status_var, value="Absent")
